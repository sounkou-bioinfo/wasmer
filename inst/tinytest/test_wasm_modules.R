...
compile_result <- wasmer_compile_wat(simple_wat, "test_module")
...
instance_result <- wasmer_instantiate("test_module", "test_instance")
...
# Test 3: List exports
exports <- wasmer_list_exports("test_instance")
...
result <- wasmer_call_function_safe("test_instance", "add", list(10L, 20L))
...
error_result <- wasmer_call_function_safe("test_instance", "nonexistent", list())
...
error_result2 <- wasmer_call_function_safe("nonexistent_instance", "add", list(1L, 2L))
